...
> 版本 v1.0 · 2026-09-12  
> 前置对话：双向钢人论证 + 四点定案  
> 代码锚点：`LongCore/JiaoLongControl/Client` + `Server`  
> 状态：**计划就绪，待视觉方向实验后进入实现**
...
| 产品代码位置 | 本工作区 `LongCore/`，后续实现以它为唯一锚点 |
...
1. 编写/更新 `LongCore/DESIGN.md`（可用已有 `create-design-md` 从当前仓反推基线，再覆盖新决策）。  
...
- 代码根：`LongCore/JiaoLongControl/Client/src/`  
